...
class page_updated extends \core\event\base {
    ...
    public static function get_name(): string {
        return get_string('eventpageupdated', 'local_helppages');
    }
    ...
    public function get_description(): string {
        return "The user with id '$this->userid' updated the help page with id '$this->objectid'.";
    }
