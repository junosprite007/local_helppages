...
class page_created extends \core\event\base {
    ...
    public static function get_name(): string {
        return get_string('eventpagecreated', 'local_helppages');
    }
    ...
    public function get_description(): string {
        return "The user with id '$this->userid' created the help page with id '$this->objectid'.";
    }
